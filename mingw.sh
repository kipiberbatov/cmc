...
# dlfcn.h will be refactored to an abstract interface for both Unix and Windows
...
make OS=Windows_NT MODE=windows/release CC=x86_64-w64-mingw32-gcc bin_{array,algebra,region,mesh}
make OS=Windows_NT MODE=windows/release INTERPRETER=wine txt_{array,algebra,region,mesh}
