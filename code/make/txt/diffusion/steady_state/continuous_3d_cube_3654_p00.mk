.PHONY: txt_diffusion_steady_state_continuous_3d_cube_3654_p00\
        txt_diffusion_steady_state_continuous_3d_cube_3654_p00_clean\
        txt_diffusion_steady_state_continuous_3d_cube_3654_p00_distclean

build/$(MODE)/txt/diffusion/steady_state/continuous_3d_cube_3654_p00:\
...
build/$(MODE)/txt/diffusion/steady_state/continuous_3d_cube_3654_p00/exact_sandstone_3062_grains_forman_potential.txt:\
  ...
  build/$(MODE)/obj/plugins/diffusion_steady_state_continuous_3d_cube_3654_p00$(.OBJ)\
  | build/$(MODE)/txt/diffusion/steady_state/continuous_3d_cube_3654_p00\
    build/$(MODE)/lib/plugins/libdiffusion$(.DLL)
	$(INTERPRETER) $<\
  --raw $(word 2, $^)\
  $(word 2, $|)\
  diffusion_steady_state_continuous_3d_cube_3654_p00_potential\
  --raw > $@
...
build/$(MODE)/txt/diffusion/steady_state/continuous_3d_cube_3654_p00/primal_strong_cochain_sandstone_3062_grains_forman_input.txt:\
  ...
  --raw $(word 2, $^)\
  $(word 2, $|)\
  diffusion_steady_state_continuous_3d_cube_3654_p00\
  > $@

build/$(MODE)/txt/diffusion/steady_state/continuous_3d_cube_3654_p00/primal_strong_cochain_sandstone_3062_grains_forman_potential.txt:\
  build/$(MODE)/bin/diffusion_steady_state_discrete_primal_strong_solve$(.EXE)\
  build/$(MODE)/txt/mesh/sandstone_3062_grains/forman.txt\
  build/$(MODE)/txt/mesh/sandstone_3062_grains/forman_cbd.txt\
  build/$(MODE)/txt/mesh/sandstone_3062_grains/forman_cbd_star.txt\
  build/$(MODE)/txt/diffusion/steady_state/continuous_3d_cube_3654_p00/primal_strong_cochain_sandstone_3062_grains_forman_input.txt\
  | build/$(MODE)/txt/diffusion/steady_state/continuous_3d_cube_3654_p00
	$(INTERPRETER) $<\
  --raw $(word 2, $^)\
...
build/$(MODE)/txt/diffusion/steady_state/continuous_3d_cube_3654_p00/primal_strong_cochain_sandstone_3062_grains_forman_flow_rate.txt:\
  ...
  build/$(MODE)/txt/mesh/sandstone_3062_grains/forman.txt\
  build/$(MODE)/txt/mesh/sandstone_3062_grains/forman_hodge.txt\
  build/$(MODE)/txt/diffusion/steady_state/continuous_3d_cube_3654_p00/primal_strong_cochain_sandstone_3062_grains_forman_input.txt\
  build/$(MODE)/txt/diffusion/steady_state/continuous_3d_cube_3654_p00/primal_strong_cochain_sandstone_3062_grains_forman_potential.txt\
  | build/$(MODE)/txt/diffusion/steady_state/continuous_3d_cube_3654_p00
	$(INTERPRETER) $<\
...
build/$(MODE)/txt/diffusion/steady_state/continuous_3d_cube_3654_p00/primal_weak_cochain_sandstone_3062_grains_forman_input.txt:\
  ...
  build/$(MODE)/txt/mesh/sandstone_3062_grains/forman.txt\
  build/$(MODE)/txt/mesh/sandstone_3062_grains/forman_vol.txt\
  build/$(MODE)/obj/plugins/diffusion_steady_state_continuous_3d_cube_3654_p00$(.OBJ)\
  | build/$(MODE)/txt/diffusion/steady_state/continuous_3d_cube_3654_p00\
    build/$(MODE)/lib/plugins/libdiffusion$(.DLL)
	$(INTERPRETER) $<\
...
build/$(MODE)/txt/diffusion/steady_state/continuous_3d_cube_3654_p00/primal_weak_cochain_sandstone_3062_grains_forman_potential.txt:\
  ...
  build/$(MODE)/txt/mesh/sandstone_3062_grains/forman.txt\
  build/$(MODE)/txt/mesh/sandstone_3062_grains/forman_inner.txt\
  build/$(MODE)/txt/diffusion/steady_state/continuous_3d_cube_3654_p00/primal_weak_cochain_sandstone_3062_grains_forman_input.txt\
  | build/$(MODE)/txt/diffusion/steady_state/continuous_3d_cube_3654_p00
	$(INTERPRETER) $<\
  --raw $(word 2, $^)\
...
txt_diffusion_steady_state_continuous_3d_cube_3654_p00:\
  $(_txt_diffusion_steady_state_continuous_3d_cube_3654_p00)

txt_diffusion_steady_state_continuous_3d_cube_3654_p00_clean:
	-$(RM) $(_txt_diffusion_steady_state_continuous_3d_cube_3654_p00)

txt_diffusion_steady_state_continuous_3d_cube_3654_p00_distclean:
	-$(RM) -r build/$(MODE)/txt/diffusion/steady_state/continuous_3d_cube_3654_p00
