...
_txt_mesh_sandstone_3062_grains :=\
  ...
  build/$(MODE)/txt/mesh/sandstone_3062_grains/kappa.txt\
  ...
  # build/$(MODE)/txt/mesh/sandstone_3062_grains/forman_hodge_coeff.txt\
...
build/$(MODE)/txt/mesh/sandstone_3062_grains/data.txt:\
  ...
  | build/$(MODE)/txt/mesh/sandstone_3062_grains
...
txt_mesh_sandstone_3062_grains_distclean:
	-$(RM) -r build/$(MODE)/txt/mesh/sandstone_3062_grains
