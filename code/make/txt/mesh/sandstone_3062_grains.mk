...
assets/mesh/sandstone_3062_grains.tess: | assets/mesh
	curl https://zenodo.org/records/18248963/files/sandstone_3062_grains.tess?download=1 > $@

assets/mesh/sandstone_3062_grains.stface: | assets/mesh
	curl https://zenodo.org/records/18248963/files/sandstone_3062_grains.stface?download=1 > $@

assets/mesh/sandstone_3062_grains.stcell: | assets/mesh
	curl https://zenodo.org/records/18248963/files/sandstone_3062_grains.stcell?download=1 > $@

assets/mesh/sandstone_3062_grains_vpore.csv: | assets/mesh
	curl https://zenodo.org/records/18248963/files/sandstone_3062_grains_vpore.csv?download=1 > $@

assets/mesh/sandstone_3062_grains_fpore.csv: | assets/mesh
	curl https://zenodo.org/records/18248963/files/sandstone_3062_grains_fpore.csv?download=1 > $@
...
build/$(MODE)/txt/mesh/sandstone_3062_grains_kappa.txt:\
  ...
  | build/$(MODE)/txt/mesh
	$< --raw $(word 2, $^) $(word 3, $^) $(word 4, $^) $(word 5, $^) $(word 6, $^) 0.0651 > $@
