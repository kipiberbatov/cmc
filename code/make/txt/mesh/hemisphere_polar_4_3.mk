...
_txt_mesh_hemisphere_polar_4_3 :=\
  ...
  build/$(MODE)/txt/mesh/hemisphere_polar_4_3/forman_cbd.txt\
  build/$(MODE)/txt/mesh/hemisphere_polar_4_3/forman_vol.txt\
  build/$(MODE)/txt/mesh/hemisphere_polar_4_3/forman_inner.txt\
  build/$(MODE)/txt/mesh/hemisphere_polar_4_3/forman_cbd_star.txt\
  build/$(MODE)/txt/mesh/hemisphere_polar_4_3/forman_hodge_coeff.txt\
  build/$(MODE)/txt/mesh/hemisphere_polar_4_3/forman_hodge.txt\

build/$(MODE)/txt/mesh/hemisphere_polar_4_3: | build/$(MODE)/txt/mesh
	mkdir -p $@

build/$(MODE)/txt/mesh/hemisphere_polar_4_3/data.txt:\
  build/$(MODE)/bin/mesh_hemisphere_polar$(.EXE)\
  | build/$(MODE)/txt/mesh/hemisphere_polar_4_3
	$(INTERPRETER) $< 4 3 > $@
...
txt_mesh_hemisphere_polar_4_3_distclean:
	-$(RM) -r build/$(MODE)/txt/mesh/hemisphere_polar_4_3
