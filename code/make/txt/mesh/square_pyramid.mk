...
_txt_mesh_square_pyramid := \
  build/$(MODE)/txt/mesh/square_pyramid/forman.txt\

build/$(MODE)/txt/mesh/square_pyramid: | build/$(MODE)/txt/mesh
	mkdir -p $@

build/$(MODE)/txt/mesh/square_pyramid/forman.txt:\
  build/$(MODE)/bin/forman$(.EXE)\
  data/mesh/square_pyramid.txt\
  | build/$(MODE)/txt/mesh/square_pyramid
...
txt_mesh_square_pyramid_distclean:
	-$(RM) -r build/$(MODE)/txt/mesh/square_pyramid
