...
\AddToHook{env/algorithm/begin}{\crefalias{theorem}{algorithm}}
...
\input{module/homomorphism-definition.tex}
\input{module/homomorphisms_form_a_module-proposition.tex}
\input{module/homomorphisms_form_a_module-proof.tex}
...
\input{lie_algebra/homomorphism-definition.tex}
...
\input{derivation/on_unital_commutative_associative_algebra_commutator_is_a_derivation-proof.tex}
...
\input{derivation/product-definition.tex}
\input{derivation/is_closed_with_respect_to_products-proposition.tex}
\input{derivation/is_closed_with_respect_to_products-proof.tex}
...
\input{smooth_manifold/vector_field/lie_derivative-all.tex}
\input{smooth_manifold/vector_field/flow-all.tex}

\section{Lie groups}
\label{section:lie_groups}
\input{smooth_manifold/lie_group/all.tex}

\section{Exterior derivative}
\label{section:exterior_derivative}
\phantom{T}
\input{smooth_manifold/differential_form/exterior_derivative_examples-all.tex}

\section{Symplectic manifolds}
\label{section:hamiltonian_systems}
\input{smooth_manifold/symplectic/all.tex}

\section{Hamiltonian systems}
\label{section:hamiltonian_systems}
\input{smooth_manifold/symplectic/hamiltonian_system-all.tex}
...
\input{diffusion/continuous/steady_state/examples/2d_d00_p01_brick_2d_2_forman-example.tex}
\input{diffusion/continuous/steady_state/examples/2d_d00_p01_brick_2d_2_forman-figure.tex}
...
\input{diffusion/continuous/steady_state/examples/2d_d00_p03_brick_2d_2_forman-example.tex}
\input{diffusion/continuous/steady_state/examples/2d_d00_p03_brick_2d_2_forman-figure.tex}
...
\input{diffusion/continuous/transient/examples/2d_d00_p00_brick_2d_2_forman-example.tex}
\input{diffusion/continuous/transient/examples/2d_d00_p00_brick_2d_2_forman-figure.tex}
...
\phantom{T}
\input{lorentzian_manifolds/all.tex}
...
\phantom{T}
\input{continuum_mechanics/all.tex}
